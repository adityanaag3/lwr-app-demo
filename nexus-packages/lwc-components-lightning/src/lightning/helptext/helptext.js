...
export default class LightningHelptext extends LightningElement {
    ...
    /**
     * The a11y text to be set inside the helper text button (not visible text).
     * When a value is set, screen readers will read the help text like this:
     * '{alternativeText} button {content}'
     * If not set, screen readers will read: 'Help button {content}'
     * @type {string}
     * @param {string} value the a11y text to set
     * @default Help
     */
    @api
    get alternativeText() {
